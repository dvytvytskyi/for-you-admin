...
Виконайте скрипт для встановлення токенів (скрипт вже містить нові довготривалі токени):
...
**Примітка:** Скрипт містить довготривалий access token (термін дії до 2027 року) та refresh token.
...
# 2. Встановити AMO CRM токени (довготривалі)
