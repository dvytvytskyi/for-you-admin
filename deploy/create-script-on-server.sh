#!/bin/bash
# Команди для створення скрипта на сервері
# Скопіюйте та виконайте на сервері

cat > /opt/admin-panel/deploy/fix-admin-on-main-domain.sh << 'SCRIPT_END'
#!/bin/bash
...
chmod +x /opt/admin-panel/deploy/fix-admin-on-main-domain.sh
echo "✅ Скрипт створено та зроблено виконуваним!"
