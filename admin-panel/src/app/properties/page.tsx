                            ...
                            <span className="block font-medium text-gray-800 text-theme-sm dark:text-white/90">
                              {property.name || 'Unnamed Property'}
                                ...
                                <button
                                  ...
                                  className="p-1 rounded hover:bg-gray-100 dark:hover:bg-white/10 transition-colors ml-1"
                                  title={copiedId === property.id ? 'Copied!' : 'Copy property name'}
                                  type="button"
                                >
                                  <CopyIcon 
                                    className={`w-4 h-4 ${copiedId === property.id ? 'text-green-500' : 'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'}`}
                                  />
                                </button>
                              </div>
