...
docker exec for-you-admin-panel-postgres-prod psql -U admin -d admin_panel -c "UPDATE properties SET photos = 'https://foryou-realestate.com/favicons/icon-light.png' WHERE \"propertyType\" = 'secondary';"
